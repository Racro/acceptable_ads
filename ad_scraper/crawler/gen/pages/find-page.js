 ...
 */
export async function randomGuessPage(page, maxGuesses, guessCriteria) {
 ...
 */
export async function findArticle(page) {
    let articleUrl;
    ...
    let guessUrl = await randomGuessPage(page, 20, async (page) => {
...
export async function findPageWithAds(page) {
    log.info(`${page.url()}: Finding random page with ads on it`);
    return randomGuessPage(page, 20, async (page) => {
