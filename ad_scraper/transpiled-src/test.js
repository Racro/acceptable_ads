...
var browser = await _puppeteer["default"].launch({
  headless: false
});
browser.on('targetcreated', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(target) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _context.t0 = console;
          _context.t1 = "targetcreated\nURL:  ".concat(target.url(), "\nType:  ").concat(target.type(), "\nOpener: ").concat((_target$opener = target.opener()) === null || _target$opener === void 0 ? void 0 : _target$opener.url(), "\nWorker? ");
          _context.next = 6;
...
cdp.on('Target.attachedToTarget', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_ref2) {
    var sessionId, targetInfo, waitingForDebugger, connection, popupCdp;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          sessionId = _ref2.sessionId, targetInfo = _ref2.targetInfo, waitingForDebugger = _ref2.waitingForDebugger;
            ...
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref4) {
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    requestId = _ref4.requestId, request = _ref4.request;
                    console.log('Fetch.requestPaused:', request.url);
                    popupCdp === null || popupCdp === void 0 || popupCdp.send('Fetch.failRequest', {
                      requestId: requestId,
                      errorReason: 'Aborted'
                    });
        ...
        case 17:
          ...
          _context3.next = 20;
          return popupCdp.send('Target.closeTarget', {
