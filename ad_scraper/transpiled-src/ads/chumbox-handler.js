...
exports.splitChumbox = splitChumbox;
...
// chumboxes.
function splitChumbox(_x) {
  return _splitChumbox.apply(this, arguments);
}
/**
 ...
 */
function _splitChumbox() {
  _splitChumbox = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ad) {
    var definitions, _i, _definitions, d, result;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          definitions = [{
            ...
            platform: 'contentad',
            selector: '.ac_container',
            screenshotParentDepth: 0
          }, {
            platform: 'feednetwork',
            selector: '.my6_item',
            screenshotParentDepth: 0
          }, {
            platform: 'mgid',
          ...
          _i = 0, _definitions = definitions;
        case 2:
          if (!(_i < _definitions.length)) {
            _context.next = 12;
            break;
          }
          d = _definitions[_i];
          _context.next = 6;
          return splitFirstPartyAd(ad, d.selector, d.screenshotParentDepth);
        case 6:
...
function splitFirstPartyAd(_x2, _x3, _x4) {
  return _splitFirstPartyAd.apply(this, arguments);
...
// }
function _splitFirstPartyAd() {
  _splitFirstPartyAd = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(container, linkSelector, parentDepth) {
    var link, fullAd, tuples, i;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return container.$$(linkSelector);
        case 2:
          link = _context3.sent;
          if (!(link.length === 0)) {
            _context3.next = 5;
        ...
        case 5:
          _context3.next = 7;
          return Promise.all(link.map( /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(l) {
              var parentHandle;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return container.evaluateHandle(function (e, depth) {
                      var current = e;
                  ...
                  case 2:
                    parentHandle = _context2.sent;
                    return _context2.abrupt("return", parentHandle);
                  case 4:
                  case "end":
        ...
        case 7:
          ...
          return _context3.abrupt("return", tuples);
        case 11:
        case "end":
